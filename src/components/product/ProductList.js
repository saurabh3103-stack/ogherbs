...
const ProductList2 = () => {
  ...
  useEffect(() => {
    ...
    axios.post('https://ogherbs.deificindia.com/customer/products', {})
      .then(response => {
        // Check if the status is 1 and products exist
      ...
      <ul>
        {products.map(product => (
          <li key={product.id}>
            ...
            <p>Description: <span dangerouslySetInnerHTML={{ __html: product.description }} /></p>
          </li>
        ))}
      </ul>
    </div>
